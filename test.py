...
# #Testing Transport
# response = requests.get('https://bhumimithr.azurewebsites.net/transport', json = {'distance': 100000, 'truck_age': '<10 Years', 'truck_size': '>5 tonnes', 
#                                                                    'load_weight': 1000, 'weight_per_unit': 1, 'annual_tonnage': 100, 'yield_percent': 98, 
#                                                                    'total_units': 1000})

# response = requests.get('https://bhumimithr.azurewebsites.net/scope3', json = {'weight_per_unit': 1, 'total_units': 1000, 'annual_tonnage': 100, 'yield_percent': 98,
...
#                                                                 'upstream': {'truck': {'ton_kms': 10000}}, 'waste': {}})
...
response = requests.get('http://127.0.0.1:5000/scope1', json = {'stationary_combustion': {'coal_anthracite':{'quantity': 10, 'source_area': ''}, 
                                                                ...
                                                                'mobile_combustion': {'passenger_car_diesel': {'on_road': {'year': 2019, 'distance': 10, 'fuel_usage': 1}}, 
                                                                                      'passenger_car_gasoline': {'on_road': {'year': 2019, 'distance': 10, 'fuel_usage': 1}}, 
                                                                ...
                                                                'fire_suppression': {'co2': {'units_consumed': 10}, 'hfc_23': {'units_consumed': 12}}, 
